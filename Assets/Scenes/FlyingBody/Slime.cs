...
public class Slime : MonoBehaviour
{
    ...
    public Func<Vector2> ScreenCeneterFunc;

    public void SetUp(Func<Vector2> ScreenCeneterFunc)
    {
        this.ScreenCeneterFunc = ScreenCeneterFunc;
    ...
    private void Update()
    {
        ...
        Vector3 movePosition = ScreenCeneterFunc();
